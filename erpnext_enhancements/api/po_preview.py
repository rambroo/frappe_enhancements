...
@frappe.whitelist()
def render_po_review_template(purchase_order, read_only=False):
    ...
    html = frappe.render_template("erpnext_enhancements/templates/includes/po_review_modal_template.html", {
        ...
        "remarks": po.get("remarks") or "",  # Add remarks from PO
        "read_only": read_only  # Pass read_only flag to template
    })
